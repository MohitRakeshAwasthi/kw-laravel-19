...
<br>
<div>
  <img src="http://kanoonvala.com/themes/default/assets/img/company-icon.jpg">
  Limited Liability Partnership 9,999 INR /-<br><br>
  <br>
  No Govt. Fees <br>Company Registration in just 15-20 Days<br><br>
  <ul>
  ...
  <h2>How the Processing is done?</h2>     
            First Step: DIN, DSC &amp; Name Approval 1-7 Days
  <br><br>
  Second Step: Submission of Form 2 8-14 Days<br><br>
  Third Step: Submission of Form 3 &amp; 4 15 to 19 Days <br><br>
  Fourth Step: Certificate  Of  Incorporation 20 to 30 Days<br><br>
  <br>
  <h2>FAQs</h2>     
            QusWhat is the difference between LLP and Private Limited Company?
  <br><br>
  AnsThe LLP always have partners and the Private Limited Company does features stake holders.<br><br>
  QusWhat if one of the partner engages himself in any misconduct?<br><br>
  AnsIn case of the LLP companies the partner who is responsible for the misconduct will be punished  and not the partners.<br><br>
  QusWhat is DPIN?<br><br>
  AnsDPIN is Designated Partner Identification Number is a unique number allotted to the company owners and it is valid for the life time.<br><br>
  QusHow to choose a name for the LLP ? <br><br>
  AnsThe LLP should have a name that is unique and easy to remember. It should not be a name that is already used before by any company/LLP and slso with any Trademark. Any offensive words or any word which is banned by the Government should not be used. It should be researched well before in the Google, MCA portal or guidelines and trademark site.<br><br>
  QusHow can someone file LLP agreement?<br><br>
  AnsUsing the Form 3 one can file LLP agreement.<br><br>
  QusHow much capital does one need to incorporate the LLP?<br><br>
  AnsThere is no such need to have a capital to incorporate the LLP.<br><br>
  QusCan a salaried person can become a partner in LLP?<br><br>
  AnsYes, s salaried person can also be partner in LLP.<br><br>
  QusCan any NRI or Foreigner be a partner in the LLP?<br><br>
  AnsYes NRI or foreigner can also be a partner of the LLP Registered company.<br><br>
  <br>
</div>
@stop
