...
<br>
<h2>Personal Loan in India</h2>
With all the advancement in the world we live in, the standard of living is getting higher. There are often such circumstances where there are sudden expenses and there is need to go for personal loan. Personal Loan is short term and there are fewer complications in it. Most of the personal loan is taken when someone wants to go on a vacation, medical expenses, restructuring debts etc. The mortgage loan takes 15-30 tears.<br><br>
<strong>Benefits of personal Loan</strong><br><br>
<ol>
...
<strong>Furthermore, personal loans are preferred because:</strong><br><br>
<ol>
...
<strong>Salaried individual</strong><br><br>
<ol>
  <li>A duly filled and signed application form</li>
  <li>An identity Proof which can be any one of these such as Passport, Aadhar card, Voter ID, Driver’s license</li>
  <li>PAN card of the applicant.</li>
...
<br>
<h2>FAQs</h2>
QusCan the personal loan be used in anything?<br><br>
AnsYes, the personal loan can be used for any purpose.<br><br>
QusWhat are the eligibility criteria for the personal loan?<br><br>
Ans<br><br>
<ol>
  <li>One should have worked in a company or should run the business for a certain number of years</li>
  <li>The amount of salary collected should be as per regulations of the lenders</li>
...
QusAre there any tax benefits for taking personal loan?<br><br>
AnsNo, there are no tax benefits for taking personal loan.<br><br>
QusHow will the loan be transferred if approved?<br><br>
AnsOnce the loan has been approved, you will get the amount wither through the check or the electronic transfer.<br><br>      
     QusIs there any charge for applying the personal loan?
<br><br>
AnsYes there is a minimal charge for applying for the personal loan.<br><br>
<br>@stop
