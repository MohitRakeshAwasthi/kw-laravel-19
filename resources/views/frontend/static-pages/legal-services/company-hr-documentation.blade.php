                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">Company HR Documents Online For <br>
                          <span>Just INR 20000/-</span></h1>
                        <p><a class="btn btn-transparent" href="company-hr-documentation.html"> Know More </a></p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-7 co-xs-12 text-left">
            <h1>Join Now to File Company HR Documents Online</h1>
          ...
          <div class="col-md-6 col-sm-5 co-xs-12 text-right">
            <div class="bread">
              <ol class="breadcrumb">
                ...
                <li class="active">Company HR Documents Online</li>
              </ol>
            </div>
            <!-- end bread --> 
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            <h2 class="text-center">Company HR Documents Online</h2>
