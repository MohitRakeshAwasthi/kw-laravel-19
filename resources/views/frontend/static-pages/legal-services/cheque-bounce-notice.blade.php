...
<div id="home" class="full-section parallax-home">
    <div class="slider-caption">
      <h2 style="font-size:25px;"> Online For <br><span>Just INR 2500/-</span></h2>
      <a class="btn btn-transparent" href="cheque-bounce-notice.html"> Know More </a></div>
  </div>
  <div class="main-content-area">
   <section class="page-title">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-7 co-xs-12 text-left">
            <h1>Join Now to Send Cheque Bounce Notice</h1>
          ...
          <div class="col-md-6 col-sm-5 co-xs-12 text-right">
            <div class="bread">
              <ol class="breadcrumb">
                ...
                <li class="active">Send Cheque Bounce Notice </li>
              </ol>
            </div>
            <!-- end bread -->
          </div>
    ...
    <h2 class="text-center">Send Cheque Bounce Notice Online</h2>
