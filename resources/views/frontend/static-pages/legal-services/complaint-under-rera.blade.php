                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">File Complaint under RERA Online For <br>
                          <span>Just INR 5999/-</span></h1>
                        <p class="text-whit"><a class="btn btn-transparent" href="complaint-under-rera.html"> Know More </a></p>
                      </div>
                    </div>
                  </div>
                </div>
