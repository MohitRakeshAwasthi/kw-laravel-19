                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">Send A Legal Notice To Builder For Delayed Possession For <br>
                          <span> Just INR 2499/-</span></h1>
                        <p class="text-whit"><a class="btn btn-transparent" href="legal-notice-to-builder.html"> Know More </a></p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-7 co-xs-12 text-left">
            <h1>Join Now to Send A Legal Notice To Builder For Delayed Possession</h1>
          ...
          <div class="col-md-6 col-sm-5 co-xs-12 text-right">
            <div class="bread">
              <ol class="breadcrumb">
                ...
                <li class="active">Send A Legal Notice To Builder For Delayed Possession</li>
              </ol>
            </div>
            <!-- end bread --> 
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            <h2 class="text-center">Send A Legal Notice To Builder For Delayed Possession</h2>
