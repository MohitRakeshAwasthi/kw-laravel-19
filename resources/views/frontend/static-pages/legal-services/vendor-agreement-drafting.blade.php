...
<div id="home" class="full-section parallax-home">
    <div class="slider-caption">
      <h2 style="font-size:25px;">Draft Your Vendor Agreement Online For <br><span>Just INR 6999/-</span></h2>
  ...
  <div class="main-content-area">
   <section class="page-title">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-7 co-xs-12 text-left">
            <h1>Join Now to Draft Your Vendor Agreement Online</h1>
          ...
          <div class="col-md-6 col-sm-5 co-xs-12 text-right">
            <div class="bread">
              <ol class="breadcrumb">
                ...
                <li class="active">Draft Your Vendor Agreement Online</li>
              </ol>
            </div>
            <!-- end bread -->
          </div>
    ...
    <h2 class="text-center">Draft Your Vendor Agreement Online</h2>
