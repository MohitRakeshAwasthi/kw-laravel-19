                    ...
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">Draft A Non-Disclosure Agreement Online For <br>
                          <span> Just INR 7000/- </span></h1>
                        <p class="text-whit"><a class="btn btn-transparent" href="non-disclosure-agreement.html"> Know More </a></p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-7 co-xs-12 text-left">
            <h1>Join Now to Draft A Non-Disclosure Agreement Online</h1>
          ...
          <div class="col-md-6 col-sm-5 co-xs-12 text-right">
            <div class="bread">
              <ol class="breadcrumb">
                ...
                <li class="active">Draft A Non-Disclosure Agreement Online</li>
              </ol>
            </div>
            <!-- end bread --> 
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            <h2 class="text-center">Draft A Non-Disclosure Agreement Online</h2>
