                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">Draft Founders Agreement Online For <br>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-sm-7 co-xs-12 text-left">
                <h1>Join Now to Draft Founders Agreement Online</h1>
              ...
              <div class="col-md-6 col-sm-5 co-xs-12 text-right">
                <div class="bread">
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Draft Founders Agreement Online</li>
                  </ol>
                </div>
                <!-- end bread --> 
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                <h2 class="text-center">Draft Founders Agreement Online</h2>
