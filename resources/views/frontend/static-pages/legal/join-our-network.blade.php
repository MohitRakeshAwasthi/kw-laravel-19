...
<div id="home" class="full-section parallax-home">
    <div class="slider-caption">
      <h2 style="font-size:25px;">Join Kanoonvala Network Of Preferred<br> Lawyers And Grow Your Reach Online.</h2>
...
<section class="custom-padding" id="how-it-work" style="background:white">
      <div class="container">
      <div class="main-heading text-center">
          <h2>Join Kanoonvala Network Of Top <br>Legal Professionals</h2>
      ...
      <div class="container">
        ...
        <div class="row" style="padding:20px;">
            ...
            <div class="col-md-12 center-responsive" >
              <button class="btn btn-primary"><a href="#login">Join Us</a></button>
            </div>
