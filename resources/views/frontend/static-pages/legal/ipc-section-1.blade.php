...
<div id="home" class="full-section parallax-home" style="background:linear-gradient(rgba(0,0,0,.6),rgba(0,0,0,.6)),url(https://www.legistify.com/img/banner/ipc.webp);height:250px;">
    <div class="slider-caption">
      <h2 style="font-size:25px;">Indian Kanoon- IPC Section 1 <br>
Title and extent of operation of the Code</h2>
      
      </div>
  </div>
 <div class="main-content-area">
   <section class="page-title" style="background:red;padding: 2px 0;">
      <div class="container">
        <div class="row">
