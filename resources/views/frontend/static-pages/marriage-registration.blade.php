	...
	<section class="custom-padding" id="how-it-work" style="background:#612f31;">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 left-responsive">
					<img src="{!! asset('old-assets/images//track.png') !!}" alt="track">
				</div>
				<div class="clearfix"></div>    
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-2 col-xs-6 col-sm-4 client-block">
					...
					<div class="client-item client-item-style-2">
						<a title="Client Logo" href="#"> <img alt="Clients Logo" src="{!! asset('old-assets/images/clients/client_5.png')!!}"> </a>
					</div>

				</div>
				<div class="col-md-2 col-xs-6 col-sm-4 client-block">
					<div class="client-item client-item-style-2">
						<a title="Client Logo" href="#"> <img alt="Clients Logo" src="{!! asset('old-assets/images/clients/client_6.png')!!}"> </a>
					</div>
				</div>
				<div class="col-md-2 col-xs-6 col-sm-4 client-block">

					<div class="client-item client-item-style-2">
						<a title="Client Logo" href="#"> <img alt="Clients Logo" src="{!! asset('old-assets/images/clients/client_7.png') !!}"> </a>
					</div>
				...
				<div class="col-md-2 col-xs-6 col-sm-4 client-block">
					...
					<div class="client-item client-item-style-2">
						<a title="Client Logo" href="#"> <img alt="Clients Logo" src="{!! asset('old-assets/images/clients/client_8.png') !!}"> </a>
					</div>
				</div>
				<div class="col-md-2 col-xs-6 col-sm-4 client-block">

					<div class="client-item client-item-style-2">
						<a title="Client Logo" href="#"> <img alt="Clients Logo" src="{!! asset('old-assets/images/clients/client_9.png') !!}"> </a>
					</div>
				...
				<div class="col-md-2 col-xs-6 col-sm-4 client-block">
					...
					<div class="client-item client-item-style-2">
						<a title="Client Logo" href="#"> <img alt="Clients Logo" src="{!! asset('old-assets/images/clients/client_10.png') !!}"> </a>
					</div>
